...
const styles = StyleSheet.create({
   ...
   actions: {
  flexDirection: 'column', // 👈 aquí el cambio
  alignItems: 'center',
  gap: 10, // para separar los botones si usas React Native 0.71+
},
...
editBtn: {
  backgroundColor: "#1976D2", // Azul vivo para editar
},
deleteBtn: {
  backgroundColor: "#D32F2F", // Rojo fuerte para eliminar
},
