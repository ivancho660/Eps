...
import { eliminarEspecialidades } from "../../Src/Servicios/EspecialidadesService";
        ...
        <View style={{ flex: 1 }}>
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    ...
                    <EspecialidadesCard
                        especialidades={item} //pasa el consultorio a la tarjeta
                        onEdit={() => handleEditar(item)}  //accion editar
                        onDelete={() => handleEliminar(item.id)} //accion eliminar 
                    />
                )}
                ListEmptyComponent={<Text>No hay especialidades Registrados.</Text>}
            />
